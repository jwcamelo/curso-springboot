...
import com.jwcamelo.cursomc.domain.Cidade;
import com.jwcamelo.cursomc.domain.Cliente;
import com.jwcamelo.cursomc.domain.Endereco;
import com.jwcamelo.cursomc.domain.Estado;
import com.jwcamelo.cursomc.domain.ItemPedido;
import com.jwcamelo.cursomc.domain.Pagamento;
...
public class CursomcApplication  implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Endereco e2 = new Endereco(null,"Avenida Matos","105","Sala 8000","Centro",
				"38777012",cli1,c2);
		...
		Pedido ped2 = new Pedido(null,sdf.parse("10/10/2017 13:45"),cli1,e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null,EstadoPagamento.QUITADO,ped1,6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null,EstadoPagamento.PENDENTE,ped2,sdf.parse("20/07/2017 17:59"),null);
